...
def resnet50(pretrained=False, num_classes=1000, include_top=True, pooling=None):
    """
    ...
    Returns:
        An instance of the ResNet50 model.
    """
    model = ResNet(
        Bottleneck,
        [3, 4, 6, 3],  # Changed from [3, 4, 23, 3] to [3, 4, 6, 3] for ResNet50
