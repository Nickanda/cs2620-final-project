...
def plot_training_stats(epochs, train_losses, train_accuracies, val_losses, val_accuracies):
    """
...
def main():
    ...
    epochs, train_losses, train_accuracies, val_losses, val_accuracies = parse_log_file(log_file)
    ...
    plot_training_stats(epochs, train_losses, train_accuracies, val_losses, val_accuracies)
    
    # Print some statistics
    print("\nTraining Statistics:")
    print(f"Initial training loss: {train_losses[0]:.3f}, Final training loss: {train_losses[-1]:.3f}")
    print(f"Initial training accuracy: {train_accuracies[0]:.2f}%, Final training accuracy: {train_accuracies[-1]:.2f}%")
    print(f"Initial validation loss: {val_losses[0]:.3f}, Final validation loss: {val_losses[-1]:.3f}")
    print(f"Initial validation accuracy: {val_accuracies[0]:.2f}%, Final validation accuracy: {val_accuracies[-1]:.2f}%")
